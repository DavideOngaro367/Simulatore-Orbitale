...
public class MioSimulatoreOrbite extends JFrame {
    ...
    public MioSimulatoreOrbite() {
        super("Simulatore orbitale ");
        ...
        while (thetaGradi < 360) {
            ...
            if(eccentricita != 0){
                ...
                if(collisione == false){
                    ...
                    String msgPerigeo = "Coordinate perigeo: " + xPerigeo + " , " + yPerigeo;
                    ...
                    g.setColor(Color.white);
                    String msgApogeo = "Coordinate apogeo: " + (int)xApogeo + " , " + (int)yApogeo;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new MioSimulatoreOrbite().setVisible(true);
        });
    }
}